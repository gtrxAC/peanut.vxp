...
/* video player launch options */
#define VM_VIDEO_PLAY_NORMAL_FLAG                             0x0  /* the behavior is same with vm_video_play_by_filepath */
#define VM_VIDEO_PLAY_WITHOUT_OPTIONS_FLAG                    0x1  /* no LSK option menu when invoked player */
#define VM_VIDEO_PLAY_WITHOUT_OPTIONS_AND_PAUSE_FLAG          0x2  /* launch the player with initially pause state */
 ...
 *  or else failure.
 *****************************************************************************/
VMINT vm_video_play_by_filepath_with_flag(VMWSTR filename, VMINT flag);
