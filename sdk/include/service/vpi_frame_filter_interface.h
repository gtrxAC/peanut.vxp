 ...
 *============================================================================
 ****************************************************************************/
#ifndef __VPI_FRAME_FILTER_INTERFACE_H__
#define __VPI_FRAME_FILTER_INTERFACE_H__
...
/*
 * Interface of frame filter delegator.
 */
class IVpiFrameFilterDelegator : public IVpiBase
{
public:
    ...
    virtual vm_image_filter_buffer_mode onGetBufferMode() = 0;

    // Override the method to process the image.
    // RETURNS: Return VM_TRUE if the filter processed. 
    //  Otherwise return VM_FALSE.
    virtual VMBOOL onProcess(VMUINT8 *outBuf, vm_image_buffer_struct &inBuf, VMFLOAT timing) = 0;
};


/*
 * Interface of frame filter.
 */
class IVpiFrameFilter : public IVpiBase
{
public:
...
#endif /* __VPI_FRAME_FILTER_INTERFACE_H__ */
