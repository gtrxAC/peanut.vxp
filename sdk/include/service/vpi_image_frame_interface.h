 ...
 * Filename:
 * ---------
 *  vpi_primitive_frame_interface.h
 *
 * Project:
 * --------
 *  Venus Plug-in Core
 ...
 *============================================================================
 ****************************************************************************/
#ifndef __VPI_IMAGE_FRAME_INTERFACE_H__
#define __VPI_IMAGE_FRAME_INTERFACE_H__
...
/*
 * Interface of image frame.
 */
class IVpiImageFrame : public IVpiBase
{
public:
    // The file name of the image.
    // 
    // NOTE: Default value is null string.
    virtual void getPath(vm_wstring_struct *wString) = 0;

    // Set the image frame content with a path
    virtual void setPath(const vm_wstring_struct &value) = 0;
    ...
    virtual void setMem(const VMUINT8 *value) = 0;
    ...
    virtual VMBOOL isNull() = 0;

    // Set the image frame to contains null image source.
    virtual void setNull() = 0;
};

#endif /* __VPI_IMAGE_FRAME_INTERFACE_H__ */
