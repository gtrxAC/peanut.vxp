...
typedef enum
{
    VM_SIM_CPHS_MSISDN_TYPE_LINE1,                     /* LINE 1 */
    VM_SIM_CPHS_MSISDN_TYPE_LINE2,                     /* LINE 2 */
    VM_SIM_CPHS_MSISDN_TYPE_TOTAL                      /* Total count of MSISDN Type */
} vm_sim_cphs_msisdn_type_enum;
 ...
 *  MSISDN number
 *****************************************************************************/
const VMWCHAR* vm_sim_cphs_get_msisdn_number(vm_sim_cphs_msisdn_type_enum msisdn_type, vm_sim_enum sim);
