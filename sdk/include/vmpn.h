...
typedef enum
{
	VM_SRV_MRE_MPR_NOTIFY_STYLE = 0,
	VM_SRV_MRE_MPR_NOTIFY_STYLE_TEXT_PREVIEW	= 0x00000001,
	VM_SRV_MRE_MPR_NOTIFY_STYLE_POPUP 			= 0x00000010,
	VM_SRV_MRE_MPR_NOTIFY_STYLE_BADGE 			= 0x00000100,
	VM_SRV_MRE_MPR_NOTIFY_STYLE_NCENTER       = 0x00001000,
	VM_SRV_MRE_MPR_NOTIFY_STYLE_LOCKSCREEN   = 0x00010000,	
	VM_SRV_MRE_MPR_NOTIFY_STYLE_SOUND         = 0x00100000,
